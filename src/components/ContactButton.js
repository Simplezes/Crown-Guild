  ...
  return (
    <div className={`${styles.wrapper} ${isOpen ? styles.active : ''}`} ref={menuRef}>
      ...
      >
        ...
        {status === 'loading' ? 'Signaling...' : 'Join Hunt'}
      </button>
      ...
      {isOpen && (
        <div className={`${styles.menu} ${dropUp ? styles.dropUp : ''} animate-mh-fade`}>
          ...
          <button className={styles.option + " " + styles.sos} onClick={handleFireSOS}>
            <div className={styles.optionIcon}>
              <Image src="/icons/MHWilds-Link_Party_Icon.png" width={18} height={18} alt="" className="pixel-art" />
            </div>
            <div className={styles.optionText}>
              <span className={styles.label}>
                {status === 'success' ? 'Beacon Fired!' : 'Fire SOS Flare'}
              </span>
          ...
          <div className={styles.note}>
            <Image src="/icons/MHWilds-Notes_Checkmark_Icon.png" width={12} height={12} alt="" className="pixel-art" />
            <span>Use Flare if host&apos;s Discord is private</span>
          </div>
